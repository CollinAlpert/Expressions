...
package com.github.collinalpert.expressions.function.math;
...
public enum BinaryOperator {
	...
	/**
	 * binary exponent operator (<code>left<sup>right</sup></code>).
	 */
	Power {
		@Override
		public Number eval(Number left, Number right) {
			...
			if (left instanceof Float) {
				return (float) Math.pow(left.doubleValue(), right.doubleValue());
			}
